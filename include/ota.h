 ...
 */
enum ota_module {
    OTA_MODULE_NET,       /**< W5500 network — ready after DHCP lease or static IP applied */
    OTA_MODULE_UART,      /**< Command UART — ready after IRQ enabled and prompt sent */
    OTA_MODULE_REST_API,  /**< REST API — ready after HTTP server started */
    OTA_MODULE_COUNT      /**< Sentinel — must be last. Max 32 modules (atomic_t width). */
};
