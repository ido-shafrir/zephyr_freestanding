...
/* ---------- Thread resources (defined in w5500_net.c) ---------- */
...
/**
 * @brief Set the IPv4 address, netmask, and gateway on the default network interface.
 *
...
/**
 * @brief Get the current IPv4 configuration (address, netmask, gateway).
 *
