...
Step-by-step instructions for performing a firmware update over the network
...
```bash
west build -b nucleo_h753zi --sysbuild
smpmgr --ip 192.168.0.84 upgrade build/app/zephyr/zephyr.signed.bin
```
...
[00:00:00.005,000] <inf> main: Starting firmware...
...
[00:00:02.008,000] <inf> w5500_net: Network interface found
